		...
		<div className={classes["nav-outer"]}>
			<Paper
				...
				className={`${classes.nav} ${
					isProjects ? classes["nav-outer-blur-bottom"] : ""
				}`}
				bg="transparent"
			>
				<Group justify="space-between" w="100%">
					<Group>
						<NavButton name={"Projects"} to={"/projects"} color={"#0369a1"} />
						<NavButton name={"Study"} to={"/study"} color={"#dc2626"} />
						<NavButton name={"About"} to={"/about"} color={"#166534"} />
					</Group>
					<Group gap={12}>
						<Group gap={8}>
